...
WebUI.navigateToUrl('https://www.chronodrive.com/')

WebUI.click(findTestObject('Choix mag/Page_Courses en ligne, faire son drive - Ch_f53ba1/span_Tous nos drives'))
