...
RunConfiguration.setExecutionSettingFile('/var/folders/cb/lqn9t8q16jx7xgdybpvh4x3w0000gn/T/Katalon/Test Cases/chemin critique 01/20221212_163403/execution.properties')
...
WebUI.click(findTestObject('Choix mag/Page_Chronodrive - Courses en ligne, course_34a53b/span_Tout accepter'))

WebUI.click(findTestObject('Choix mag/Page_Chronodrive - Courses en ligne, course_34a53b/span_Choisir'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Courses en ligne, faire son drive - Ch_f53ba1/span_Me connecter'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Chronodrive/span_Tout accepter'))

WebUI.setText(findTestObject('Object Repository/CC 01/Page_Chronodrive/input_Dj client_login'), GlobalVariable.client_login)

WebUI.setText(findTestObject('Object Repository/CC 01/Page_Chronodrive/input_E-mail ou numro client_password'), GlobalVariable.client_password)

WebUI.click(findTestObject('Object Repository/CC 01/Page_Chronodrive/span_Me connecter'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Courses en ligne, faire son drive - Ch_f53ba1/span_Rayons'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Courses en ligne, faire son drive - Ch_f53ba1/span_Fruits  Lgumes'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Courses en ligne, faire son drive - Ch_f53ba1/span_Fruits'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Courses en ligne, faire son drive - Ch_f53ba1/span_Raisins'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_chronodrive  rayon raisins/svg_Retirer du panier  Raisin blanc sans pp_aedfe6'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Courses en ligne, faire son drive - Ch_f53ba1/span_Favoris'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Favoris - Chronodrive/button_Ajouter au panier  Pomme de terre  c_fe3ab7'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Favoris - Chronodrive/button_Ajouter au panier  Raisin blanc sans_941937'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Favoris - Chronodrive/span_Promos'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Promotions et offres spciales - chronodrive/button_Ajouter au panier  Bouches au chocol_38e4f9'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Promotions et offres spciales - chronodrive/span_Ol'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Promotions et offres spciales - chronodrive/button_Ajouter au panier  Infusion de fruit_bed88e'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Promotions et offres spciales - chronodrive/span_25,69'))

WebUI.click(findTestObject('Object Repository/CC 01/Page_Promotions et offres spciales - chronodrive/button_Ajouter au panier  Raisin blanc sans_941937'))
